  ...
  return (
    <div>
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-2 ">
          {categories?.map((category) => (
            <div
              ...
              style={{
                backgroundImage: `url("http://127.0.0.1:1337${category?.attributes?.image?.data?.attributes.formats.medium.url}")`,
      ...
      <section className="relative">
        <div className="absolute inset-0 bg-gray-200 opacity-50 rounded-md"></div>        {/* Background overlay */}
            ...
            <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
              ...
              <div className="flex flex-row justify-center">
                <button
                  ...
                  onClick={() =>
                    alert("Sorry, but I am still working on it...")
                  }
                >
                  Subscribe
                </button>
